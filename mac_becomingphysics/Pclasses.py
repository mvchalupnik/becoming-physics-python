...
ochem_lectures = [["Here are some reactions. These reactions have mechanisms that are part logical "\
...
boringfinal = Final("Boring Physics",
...
fakefinal = Final("Controversial Physics",
...
classlist = [Pclass("Cool Physics", 15, 15, 0, 
            cool_physics_lectures, coolfinal), 
Pclass("Boring Physics", -15, 5, 0, boring_physics_lectures, boringfinal), 
Pclass("Fake Physics", -5, 5, 0, fake_physics_lectures, fakefinal),
Pclass("Math Physics", -20, 20, 0, math_physics_lectures, mathfinal),
Pclass("Organic Chemistry",-15,-5, 0, ochem_lectures, ochemfinal)]
...
sadEnding = Ending("Ending 1 of 6: Sad Hermit",
                    'pics/hermit.png',
...
noClassesEnding = Ending("Ending 2 of 6: You didn't enroll in any classes?",
                         'pics/noclasses.png',
...
badStudentEnding = Ending("Ending 3 of 6: Bad Student",
                          'pics/badstudent.png',
...
scopeEnding = Ending("Ending 4 of 6: Too much research", 
                     'pics/scope1.jpg', 
...
gradSchoolEnding = Ending("Ending 5 of 6: Physicist",
                          'pics/physicist.png',
...
equationEnding = Ending("Ending 6 of 6: Success!",
